import logo from '@/images/creators/jenni__mj.png'
import imageHero from './hero.jpg'
import imageDebraFiscal from './debra-fiscal.jpg'

export const caseStudy = {
  instaHandle: 'jenni__mj',
  outcomes:
    'Create entertaining reels and reach targetted subscriber count in 10 days',
  duration: '10 days (Hybrid - 4 days in-person and 6 days online)',
  pricing: '4999',
  admit: '15',
  client: 'jenni__mj',
  title: 'Earning a lakh from creating entertaining reels with Jeni MJ',
  description:
    'Jeni is a renowned content creator who creates entertaining content across socials predominantly in youtube and instagram. She has a collective follower base of over 5 million and she’s the brand ambassador of Youtube shorts for Tamilnadu. In this cohort, you get to travel with Jeni and learn from her about the ways through which she is creating content and how she is attracting brand collaborations',
  summary: [
    'Jeni is a renowned content creator who creates entertaining content across socials predominantly in youtube and instagram. She has a collective follower base of over 5 million and she’s the brand ambassador of Youtube shorts for Tamilnadu. In this cohort, you get to travel with Jeni and learn from her about the ways through which she is creating content and how she is attracting brand collaborations',
  ],
  logo,
